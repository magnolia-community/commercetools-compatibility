 ...
 */
public class CategoriesListFieldFactory extends AbstractFieldFactory<AbstractListField.Definition, PropertysetItem> {
    ...
    @Inject
    public CategoriesListFieldFactory(AbstractListField.Definition definition, Item relatedFieldItem, FieldFactoryFactory fieldFactoryFactory, ComponentProvider componentProvider, UiContext uiContext, I18NAuthoringSupport i18nAuthoringSupport) {
